...
define('SG_BACKUP_FILE_PATHS_EXCLUDE', $wpContent.'/'.$wpPlugins.'/backup/,'.$wpContent.'/'.$wpPlugins.'/backup-guard-pro/,'.$wpContent.'/'.$wpUploads.'/backup-guard/,'.$wpContent.'/'.$wpUploads.'/sg_symlinks/');
